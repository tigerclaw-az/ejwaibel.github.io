...
Software developer focused on the latest and greatest in web development. Exceptional problem-solver with a think outside the box mentality. Focused on other people and being of true help and service to them.  Broad skill set with 12 years of software development experience and 7 years of software configuration management expertise. A time oriented, results driven project manager consistently capable of finding the long term sustainable solution instead of a temporary fix.
